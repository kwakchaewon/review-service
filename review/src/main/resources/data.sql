...
insert into user_auth (user_id, authority_name) values (1, 'ROLE_USER');
insert into user_auth (user_id, authority_name) values (1, 'ROLE_ADMIN');
insert into user_auth (user_id, authority_name) values (2, 'ROLE_USER');